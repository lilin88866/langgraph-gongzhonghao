"""Toutiao real content API client."""
...
class ToutiaoApiClient(PlatformHttpApiClient):
    """HTTP client for Toutiao account, article, work, and search data."""
    ...
    def __init__(self, *, base_url: str, api_key: str | None = None) -> None:
        super().__init__(
            ...
            base_url=base_url,
            api_key=api_key,
            source_api="toutiao-content-api",
        )

    @classmethod
    def from_env(cls) -> "ToutiaoApiClient | None":
